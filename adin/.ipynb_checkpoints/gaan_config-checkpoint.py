...
class GAAN_config:
    ...
    def __init__(self, noise_dim=16, hid_dim=64, num_layers=4, dropout=0.0, weight_decay=0.0, act=nn.ReLU, backbone=None, contamination=0.1, lr=0.004, epoch=100, gpu=-1, batch_size=0, verbose=0):
        """
        Parameters
        ----------
